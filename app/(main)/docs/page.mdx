...
<video src="/assets/videos/home_request.mp4" className="mb-8 border-8 border-base-100 rounded-lg" autoPlay disablePictureInPicture disableRemotePlayback controlsList="nodownload nofullscreen noplaybackrate" muted loop></video>
